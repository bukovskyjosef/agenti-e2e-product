...
Resolve `bukovskyjosef/agenti-e2e-control` through trusted GitHub metadata, pin one exact `control_plane_sha`, then resolve this repository through that revision's `projects/registry.yml`. Current work authority remains in this repository's Issue/PR; product truth remains in this repository.
